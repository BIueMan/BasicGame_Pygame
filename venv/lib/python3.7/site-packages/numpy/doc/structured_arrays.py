...
:ref:`Data Type Properties <arrays.dtypes.constructing>` reference page, and in
summary they are:
...
:ref:`Data Type Properties <arrays.dtypes.constructing>`.  Here, ``base_dtype`` is
...
Viewing Structured Arrays Containing Properties
--------------------------------------------
